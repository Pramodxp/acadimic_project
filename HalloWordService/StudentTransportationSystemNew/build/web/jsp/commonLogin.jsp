	...
	<div id="header-wrapper">
		<div id="header">
			...
			<div id="menu">
				<ul>
					...
					<li class="current_page_item"><a href="loginForm.do">Login
							Page</a></li>
		...
		<div id="banner">
			<div class="img-border">
				<a href="#"><img src="images/common.jpg" width="1120"
					height="300" alt="" /></a>
			</div>
		</div>
	</div>
									...
									<td height="40" colspan="2">
										<div align="center">
											<input type="submit" value="login"
												onclick="return commonLoginFormValidate()"></input>
										</div>
									</td>
								</tr>
							</table>
