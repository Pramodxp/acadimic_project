...
<body>
	<div id="header-wrapper">
		<div id="header">
			...
			<div id="menu">
				<ul>
					...
					<li class="current_page_item"><a href="hipLoginForm.do">HIP</a></li>
		...
		<div id="banner">
			<div class="img-border">
				<a href="#"><img src="images/hip.jpg" width="1120" height="300"
					alt="" /></a>
			</div>
		</div>
	</div>
	<div id="wrapper">
		<div id="page-wrapper">
			<div id="page">
				<div id="content">
					<h2>Healthcare Infrastructure Provider....!</h2>
					<h2>${LOGIN_STATUS}</h2>
					<p>
						<form name="loginForm" action="./hipLogin.do" method="post">
