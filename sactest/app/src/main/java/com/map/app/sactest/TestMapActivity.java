...
public class TestMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Toast.makeText(getApplicationContext(), "sachin!" + displayText, Toast.LENGTH_LONG).show();
        try {
            JSONArray jsonarr = new JSONArray(displayText);
            for (int i = 0; i < jsonarr.length(); i++) {

                JSONObject jsonobj = jsonarr.getJSONObject(i);
                LatLng sydney = new LatLng(Double.parseDouble(jsonobj.getString("stupiklat")), Double.parseDouble(jsonobj.getString("stupiklang")));
                mMap.addMarker(new MarkerOptions().position(sydney).title(jsonobj.getString("stupikplace")));
        ...
        //LatLng sydney2 = new LatLng(-35, 151);
    ...
    private class AsyncCallWS extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            displayText = WebService.invokegetdriverstupicklist(driver, "getdriverapprovelist");
            return null;
        }
